...
#I'm removing everything above 100 ug/l based on the fact that seems unrealistic. Could change this to a higher cutoff or remove cutoff.
training <- training %>% filter(chl_a <= 100)
...
set.seed(100) 
test <- training %>% sample_frac(0.09)
...
ggplot(plt, aes(Prediction,Reference, fill= Freq)) +
        ...
        scale_x_discrete(labels=c("Hypereutrophic", "Eutrophic","Oligtrophic/Mesotrophic")) +
