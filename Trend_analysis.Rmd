...
#1220 / 2458 lakes are not chaning (50 % of lakes)

trending_eutrophic <- trends %>%
  filter(eutrophic_delta > 10, oligotrophic_delta < -10)

#112 / 2458 lakes are trending towards eutrophic states (5%)

trending_oligotrophic <- trends %>%
  filter(oligotrophic_delta > 10 , eutrophic_delta < - 10)

#434 / 2458 lakes are trending towards oligotrophic states (18%)
